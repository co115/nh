...
try:
    ...
    if "sites" in data:
        ...
        new_site2 = {
            ...
            "searchable": 0,
            "changeable": 0,
            "jar": "./jar/wex.txt;md5;8df01fad5f3603ee4fb70956792346ca"
        }
    ...
    keys_to_remove = ["豆豆","config","csp_Netfixtv","csp_Netfixtv2","csp_Wogg","csp_Duopan","csp_UC","csp_XiaoYi","csp_MiSou","荐片"]
