...
try:
    ...
    if "sites" in data:
        ...
        new_site3 = {
            ...
            "searchable": 0,
            "changeable": 0,
            "jar": "./jar/wex.txt;md5;2f7523ee7fb31564c17ab504b122e720"
        }
        
        data["sites"].insert(0, new_site)
        data["sites"].insert(2, new_site1)
        data["sites"].insert(1, new_site2)
        data["sites"].insert(3, new_site3)

    else:
        print('"sites" 键不在数据中')

    keys_to_remove = ["豆瓣","配置","csp_Wogg","csp_Netfixtv","小怡","csp_UC","米搜","荐片"]
