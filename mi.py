...
try:
    ...
    for site in data.get("sites", []):
        if site.get("key") == "csp_Wwys":
            site["name"] = "📺看电视吧"
            data["sites"].insert(0, data["sites"].pop(data["sites"].index(site)))  # 将修改后的项移到第一个位置
            break 
    ...
    if "sites" in data:
        ...
        new_site2 = {
            ...
            "searchable": 0,
            "changeable": 0,
            "jar": "./jar/wex.txt;md5;b2c4ec623fdb1f2e25327581f850d560"
        }
    ...
    keys_to_remove = ["豆豆","config","csp_Wogg","csp_Netfixtv","csp_UC","csp_XiaoYi","csp_MiSou","荐片"]
