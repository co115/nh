...
try:
    ...
    if not match:
      ...
      "国产动漫"
        ...
        keys_to_remove = ["MDrive","玩偶","YGP","seed","ZPan","JPan","抠搜","UC","贱贱","新6V","PanSso","YpanSo","BpanSo","抠搜","xzso","米搜","夸搜","Aliso","YiSo","wx","fan","seed","Bili","Biliych","荐片"]
